...
//		BoardVO bvo = bsv.getDetail(bno);
	...
	@PostMapping("/modify")
	public String modify(BoardVO bvo, RedirectAttributes r, @RequestParam(name="files", required = false)MultipartFile[] files) {
		List<FileVO> flist = null;
		if(files[0].getSize()>0) {
	...
	@DeleteMapping(value="/file/{uuid}/{bno}", produces = MediaType.TEXT_PLAIN_VALUE)
